...
public class JokerCustomKeyBoradView extends KeyboardView {
    ...
    public JokerCustomKeyBoradView(Context context, AttributeSet attrs) {
        super(context, attrs);
        paint = new Paint();
    ...
    public JokerCustomKeyBoradView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void drawText(Canvas canvas, Keyboard.Key key) {
        if (key.label != null) {
            ...
            try {
                ...
                paint.setTextSize(ResourceUtil.Companion.sp2px (14));
                if (key.codes[0] == -4) {
